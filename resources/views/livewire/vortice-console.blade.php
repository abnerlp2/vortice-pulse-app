<div wire:poll.5s class="max-w-4xl mx-auto p-6 bg-white shadow-xl rounded-2xl">
    <div class="border-b pb-4 mb-6 flex justify-between items-center">
        ...
        <div class="text-right">
            ...
            <p class="text-2xl font-bold text-brand-blue">{{ $total_votes }}</p>
        </div>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <!-- Tarjeta de Promedio -->
        <div class="bg-brand-light rounded-xl p-6 flex flex-col items-center justify-center border border-gray-100 shadow-sm">
            ...
            <div class="flex items-baseline space-x-2">
                ...
                <svg class="w-10 h-10 text-brand-orange fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="rounded-xl p-6 flex flex-col items-center justify-center border shadow-sm transition-colors duration-500
            ...
            @elseif($std_dev > 1.2)
                bg-brand-orange/10 border-brand-orange text-brand-orange animate-pulse
            @else
                bg-brand-light border-gray-200 text-gray-800
            @endif
        ">
            ...
            <div class="mt-4 text-sm font-medium px-4 py-1 rounded-full 
                ...
                @elseif($std_dev > 1.2) bg-brand-orange/10 text-brand-orange 
