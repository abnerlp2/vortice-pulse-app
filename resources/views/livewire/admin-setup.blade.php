<div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex items-center justify-between mb-8 pb-4 border-b border-gray-200">
        ...
        <a href="{{ route('dashboard') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
                ...
                >
                    ...
                    >
                        <div class="space-y-1 text-center">
                            ...
                            @if ($file)
                                <p class="mt-2 text-sm font-semibold text-indigo-600">{{ $file->getClientOriginalName() }}</p>
                            @endif
                        </div>
