...
>
    <header class="sticky top-0 z-50 w-full bg-white border-b border-gray-200 shadow-sm py-3 px-4 flex justify-center items-center">
        <img src="<?php echo e(asset('images/vortice-logo.svg')); ?>" alt="Vórtice 2026" class="h-8 w-auto">
    </header>
...
$message = $__bag->first($__errorArgs[0]); ?> 
                <span x-transition.fade class="text-red-500 text-sm block text-center font-medium"><?php echo e($message); ?></span> 
            <?php unset($message);
...
<?php /**PATH /Users/abner.trejos/Developer/vortice-pulse-app/resources/views/livewire/mobile-evaluator.blade.php ENDPATH**/ ?>